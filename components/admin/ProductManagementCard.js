        ...
        <Link href="/admin/productos" className="block">
            <div className="neobrutalist-card group">
                ...
                <div className="card-title-area">
                    <span className="text-sm sm:text-base">Gestionar</span>
                    <span className="card-tag">Pro</span>
                </div>

                {/* Body */}
                <div className="card-body">
                    <div className="card-description">
                        Agregar, editar o eliminar productos del catálogo. Control total sobre tu inventario.
                    </div>
                    ...
                    <div className="feature-grid">
                        <div className="feature-item">
                            ...
                            <span className="feature-text">Crear Nuevo</span>
                        </div>
                        ...
                        <div className="feature-item">
                            ...
                            <span className="feature-text">Editar Info</span>
                        </div>
                        ...
                        <div className="feature-item">
                            ...
                            <span className="feature-text">Ver Stock</span>
                        </div>
                        ...
                        <div className="feature-item">
                            ...
                            <span className="feature-text">Eliminar</span>
                        </div>
                    </div>
                    ...
                    <div className="card-actions">
                        <div className="price">
                            ...
                            <span className="price-period">full control</span>
                        </div>
                ...
                <div className="stamp">
                    <span className="stamp-text">Stock</span>
                </div>
