...
export default function ManualSaleCard() {
    return (
        <Link href="/admin/ventas/nueva" className="block">
            <div className="neobrutalist-card group">
                ...
                <div className="card-title-area">
                    ...
                    <span className="card-tag">Rápido</span>
                </div>

                {/* Body */}
                <div className="card-body">
                    <div className="card-description">
                        Registra ventas de mostrador o telefónicas al instante. Gestiona productos y genera pedidos rápidamente.
                    </div>
                    ...
                    <div className="feature-grid">
                        <div className="feature-item">
                            ...
                            <span className="feature-text">Agregar Items</span>
                        </div>
                        ...
                        <div className="feature-item">
                            ...
                            <span className="feature-text">Stock Auto</span>
                        </div>
                        ...
                        <div className="feature-item">
                            ...
                            <span className="feature-text">Calc. Total</span>
                        </div>
                        ...
                        <div className="feature-item">
                            ...
                            <span className="feature-text">Registro</span>
                        </div>
                    </div>
                    ...
                    <div className="card-actions">
                        <div className="price">
                            ...
                            <span className="price-period">sin límites</span>
                        </div>
                ...
                <div className="stamp">
                    <span className="stamp-text">Ready</span>
                </div>
