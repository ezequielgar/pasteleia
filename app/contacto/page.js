                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            >
                                <Card className="p-8 md:p-12 bg-gradient-to-br from-accent-500 to-accent-600 text-white text-center">
                                    ...
                                    <WhatsAppButton
                                        message="¡Hola! Me gustaría hacer una consulta sobre los productos de Pasteleia."
                                    >
                                ...
                                <Card className="p-8 text-center">
                                    ...
                                    <div className="flex justify-center space-x-6">
                                        <button
                                            ...
                                            className="w-12 h-12 rounded-full bg-accent-500 flex items-center justify-center text-white hover:bg-accent-600 transition-colors cursor-pointer"
                                        >
